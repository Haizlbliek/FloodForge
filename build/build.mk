...
SOURCES=src/glad.c $(wildcard src/*.cpp) $(APP_SOURCES) $(wildcard src/font/*.cpp) $(wildcard src/math/*.cpp) $(wildcard src/popup/*.cpp) $(wildcard src/ui/*.cpp)
CPPFLAGS += --std=c++17
INCLUDES = -I"include/"
...
FloodForge: $(if $(REQPKGS),pkgcheck) $(OBJS)
	@echo [LNK] $@
