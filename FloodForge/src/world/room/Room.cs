...
public class Room : WorldDraggable {
	...
	public virtual void DrawBlack(Vector2 position) {
	...
	public virtual void Draw(Vector2 renderedPosition, WorldWindow.RoomPosition positionType, bool asReplacement = false) {
